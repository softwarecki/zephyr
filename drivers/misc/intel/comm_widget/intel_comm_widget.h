 ...
 */
static inline bool cw_upstream_ready()
{
 ...
 */
static inline void cw_upstream_do_pw()
{
	uint32_t cmd = sys_read32(CW_BASE + USCMD);
 ...
 */
static inline void cw_upstream_clear_msgsent()
{
 ...
 */
static inline void cw_upstream_wait_for_sent()
{
	while ((sys_read32(CW_BASE + USSTS) & USSTS_MSGSENT) == 0) {
		k_busy_wait(1);
	}
